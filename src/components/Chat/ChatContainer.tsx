...
export const ChatContainer: React.FC<ChatContainerProps> = ({
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content: carInfo
        ? `Hi there! I'm your automotive assistant. I see you're asking about your ${
            carInfo.year || ""
  ...
  const handleSendMessage = async (content: string) => {
    ...
    try {
      ...
      const response = await generateCarResponse(content, carInfo)
  ...
  return (
    <div
      className={`flex flex-col h-full glass-panel rounded-2xl chat-container-shadow overflow-hidden ${className}`}
    >
